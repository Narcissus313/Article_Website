...
// genderSelection.value = userData.gender;
genderDiv.innerHTML = ``;
genderDiv.innerHTML = `
...
editInfoBtn.addEventListener("click", (e) => {
	...
	// genderSelection.removeAttribute("disabled");
	// genderSelection.classList.remove("text-bg-light");
	// genderSelection.classList.add("text-bg-white");
	genderDiv.innerHTML = `
    <select class="form-select form-select-lg text-black fs-6"
